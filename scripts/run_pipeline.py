...
from src.utils.validate_data_pre_preprocessing import validate_telco_data    # Data quality validation of the RAW data
from src.utils.validate_data_post_preprocessing import validate_data         # Data quality validation AFTER preprocessing
def main(args):
    """
    ...
    mlruns_path = args.mlflow_uri or project_root.joinpath("mlruns").as_posix()
    ...
    with mlflow.start_run():
        ...
        # validates data quality after preprocessing and before training # 
        print("Validating raw data quality ...")
        is_valid, failed = validate_telco_data(df)
        mlflow.log_metric("raw_data_quality_pass", int(is_valid))  # Track data quality over time
        ...
        mlflow.log_metric("processed_data_quality_pass", int(is_valid))  # Track data quality over time
        ...
        # === STAGE 5: Feature Engineering - CRITICAL for Model Performance ===
        ...
        # === STAGE 7: Model Training with Optimized Hyperparameters ===
